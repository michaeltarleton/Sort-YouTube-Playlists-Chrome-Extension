...
const addSearchField = function (playlistDivSelector, playlistsSelector) {
    ...
    // Div
    const searchBar3 = document.createElement('div')
    searchBar3.className =
        'input-content label-is-floating style-scope tp-yt-paper-input-container'
    searchBar3.style.paddingLeft = '2rem'
    searchBar3.style.paddingRight = '-2rem'
    searchBar3.style.paddingTop = '1rem'

    // Iron Input
    const searchBar2 = document.createElement('iron-input')
    searchBar2.className = 'input-element style-scope tp-yt-paper-input'
    searchBar2.innerHTML =
        '<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/></svg>'
    searchBar2.getElementsByTagName('svg')[0].style.float = 'left'
    searchBar2.getElementsByTagName('svg')[0].style.position = 'relative'
    ...
    searchBar3.appendChild(searchBar2)
    searchBar2.appendChild(searchBar)
    playlistsNode.parentNode.insertBefore(searchBar3, playlistsNode)
}
